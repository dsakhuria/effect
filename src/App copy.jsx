...
function App() {
  ...
  let categoryStyles = ("-bg-white text-black p-4 rounded-lg hover:bg-[#1f1f1f] hover:text-white transition-all")
  ...
  return (
    <main className="bg-[#a2a2a2] w-full h-screen">
      ...
      <middle className="z-0 w-full h-auto bg-white flex flex-col items-center justify-center">
        <categories className="w-full h-auto py-5 flex items-center justify-evenly">
        ...
        <sales className="py-10 w-full h-auto flex flex-col items-center justify-center">
          <span className="w-full h-auto py-10 text-center text-3xl text-black">
            Sales & Offers
          </span>
          <effectiveItems className=" mb-[90px] container scroll-1">
            <div className="card">
              <div className="card__image"></div>
              <div className="card__content">
                <span className="card__title">ეფექტური პროდუტქი #1</span>
                <p className="card__describe">
                  აქ რაღაცა რუღაცა, სადაიჯ აწდ მა0წიმდ მა მდ0წამდ ია0წ მ0იაწმ
                  დ0მაწ
                </p>
              </div>
            </div>
            <div className="card">
              <div className="card__image"></div>
              <div className="card__content">
                <span className="card__title">ეფექტური პროდუტქი #2</span>
                <p className="card__describe">
                  აქ რაღაცა რუღაცა, სადაიჯ აწდ მა0წიმდ მა მდ0წამდ ია0წ მ0იაწმ
                  დ0მაწ
                </p>
            ...
            <div className="card">
              <div className="card__image"></div>
              <div className="card__content">
                <span className="card__title">ეფექტური პროდუტქი #3</span>
                <p className="card__describe">
                  აქ რაღაცა რუღაცა, სადაიჯ აწდ მა0წიმდ მა მდ0წამდ ია0წ მ0იაწმ
                  დ0მაწ
                </p>
          ...
          <firstRow className="bg-transparent w-full h-auto flex items-center justify-center p-2.5">
            <div className="card">
          ...
          <secondRow className="bg-transparent w-full h-auto flex items-center justify-center p-2.5">
            <div className="card">
              <div className="card-img"></div>
              <div className="card-info">
                <p className="text-title">Product title </p>
          ...
          <thirdRow className="bg-transparent w-full h-auto flex items-center justify-center p-2.5">
            <div className="card">
              <div className="card-img"></div>
              <div className="card-info">
                <p className="text-title">Product title </p>
      ...
      <footer
        className="py-10 text-white w-full h-auto bg-black flex flex-col items-center justify-center
        "
      >
